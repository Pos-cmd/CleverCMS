...
export const useRouteStore = defineStore(SetupStoreId.Route, () => {
  ...
  async function initConstantRoute() {
    ...
    if (authRouteMode.value === 'static') {
      ...
      const data = await API.route.fetchGetConstantRoutes()
  ...
  function initStaticAuthRoute() {
    ...
    if (userStore.isStaticSuper) {
      ...
      const filteredAuthRoutes = filterAuthRoutesByRoles(staticAuthRoutes, userStore.getUserInfo.roles)
  ...
  async function initDynamicAuthRoute() {
    const data = await API.route.fetchGetUserRoutes()
  ...
  async function getIsAuthRouteExist(routePath: RouteMap[RouteKey]) {
    ...
    const data = await API.route.fetchIsRouteExist(routeName)
