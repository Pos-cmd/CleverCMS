...
import { PageTab } from '@clever/materials'
...
<template>
  <DarkModeContainer class="size-full flex-y-center px-16px shadow-tab">
    ...
    <AppReloadButton :loading="!appStore.reloadFlag" @click="refresh" />
    <AppFullScreen :full="appStore.fullContent" @click="appStore.toggleFullContent" />
  </DarkModeContainer>
  <ContextMenu
